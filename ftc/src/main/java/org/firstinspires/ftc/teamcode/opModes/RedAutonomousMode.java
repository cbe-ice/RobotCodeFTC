...
@Autonomous(name = "Red Auto Mode", group = "Auto")
public class RedAutonomousMode extends OpMode {
    ...
    PathState pathState;
    final Pose startPose = new Pose(123.5, 121.5, Math.toRadians(36.5));
    final Pose shootPose = new Pose(104, 102, Math.toRadians(50));
    final Pose startRow1 = new Pose(96, 84, Math.toRadians(0));
    final Pose endRow1 = new Pose(128, 84, Math.toRadians(0));
    final Pose startRow2 = new Pose(96, 60, Math.toRadians(0));
    final Pose endRow2 = new Pose(135, 60, Math.toRadians(0));
    final Pose exitRow2 = new Pose(120, 60, Math.toRadians(0));
    final Pose startRow3 = new Pose(96, 36, Math.toRadians(0));
    final Pose endRow3 = new Pose(135, 36, Math.toRadians(0));
    final Pose endPose = new Pose(109.5, 93.5, Math.toRadians(43.5));
